...
main() {
    ...
    download "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/meta/geo-lite/geosite/tiktok.yaml" "${FOLDER}"tiktok.yaml
    ...
    download "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/meta/geo-lite/geosite/openai.yaml" "${FOLDER}"openai.yaml
    ...
    download "https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/google_play.lst" "${FOLDER}"google-play.txt
    ...
    download "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/meta/geo/geosite/mailru-group.list" "${FOLDER}"mailru.txt
